...
user1 = User.create!(username: 'demoUser', password: '123456')
user2 = User.create!(username: 'Emily L', password: '123456')
user3 = User.create!(username: 'Ethan G', password: '123456')
user4 = User.create!(username: 'Kirby N', password: '123456')
user5 = User.create!(username: 'Bill C', password: '123456')
user6 = User.create!(username: 'Bill K', password: '123456')
user7 = User.create!(username: 'Ethan L', password: '123456')
user8 = User.create!(username: 'Michael L', password: '123456')
user9 = User.create!(username: 'Sean M', password: '123456')
user10 = User.create!(username: 'Ian F', password: '123456')
user11 = User.create!(username: 'Katie H', password: '123456')
user12 = User.create!(username: 'Steven W', password: '123456')
user13 = User.create!(username: 'Kenny L', password: '123456')
